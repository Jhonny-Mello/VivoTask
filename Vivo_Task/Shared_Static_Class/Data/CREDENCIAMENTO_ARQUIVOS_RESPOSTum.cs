...
public partial class CREDENCIAMENTO_ARQUIVOS_RESPOSTum
{
    [Key]
    ...
    [InverseProperty("CREDENCIAMENTO_ARQUIVOS_RESPOSTa")]
    public virtual CREDENCIAMENTO_RESPOSTum ID_RESPOSTANavigation { get; set; }
}